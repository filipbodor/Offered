                ...
                <div class="mt-4">
                    <x-label for="terms">
                        <div class="flex items-center">
                            ...
                            <div class="ms-2">
                                {!! __('Súhlasím s :terms_of_service a :privacy_policy', [
                                        'terms_of_service' => '<a target="_blank" href="'.route('terms.show').'" class="underline text-sm text-gray-600 hover:text-gray-900 rounded-md focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-indigo-500">'.__('podmienkami používania').'</a>',
                                        'privacy_policy' => '<a target="_blank" href="'.route('policy.show').'" class="underline text-sm text-gray-600 hover:text-gray-900 rounded-md focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-indigo-500">'.__('zásadami ochrany osobných údajov').'</a>',
                                ]) !!}
                            </div>
                        </div>
                    </x-label>
